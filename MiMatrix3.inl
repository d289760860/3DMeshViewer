...
Matrix3<Real>::Matrix3 (const Matrix3& rkM)
{
    ...
    memcpy_s(m_afEntry,uiSize,rkM.m_afEntry,uiSize);
}
//----------------------------------------------------------------------------
template <class Real>
    ...
    Real& rfZAngle) const
{
    ...
    if (m_afEntry[2] < (Real)1.0)
    {
        if (m_afEntry[2] > -(Real)1.0)
        {
            ...
            rfYAngle = (Real)Math<Real>::ASin((double)m_afEntry[2]);
    ...
    Real& rfYAngle) const
{
    ...
    if (m_afEntry[1] < (Real)1.0)
    {
        if (m_afEntry[1] > -(Real)1.0)
        {
            ...
            rfZAngle = (Real)Math<Real>::ASin(-(double)m_afEntry[1]);
    ...
    Real& rfZAngle) const
{
    ...
    if (m_afEntry[5] < (Real)1.0)
    {
        if (m_afEntry[5] > -(Real)1.0)
        {
            ...
            rfXAngle = (Real)Math<Real>::ASin(-(double)m_afEntry[5]);
    ...
    Real& rfXAngle) const
{
    ...
    if (m_afEntry[3] < (Real)1.0)
    {
        if (m_afEntry[3] > -(Real)1.0)
        {
            ...
            rfZAngle = (Real)Math<Real>::ASin((double)m_afEntry[3]);
    ...
    Real& rfYAngle) const
{
    ...
    if (m_afEntry[7] < (Real)1.0)
    {
        if (m_afEntry[7] > -(Real)1.0)
        {
            ...
            rfXAngle = (Real)Math<Real>::ASin((double)m_afEntry[7]);
    ...
    Real& rfXAngle) const
{
    ...
    if (m_afEntry[6] < (Real)1.0)
    {
        if (m_afEntry[6] > -(Real)1.0)
        {
            ...
            rfYAngle = (Real)Math<Real>::ASin(-(double)m_afEntry[6]);
...
//----------------------------------------------------------------------------
template <class Real>
Vector3<Real> Rotate( const Vector3<Real>& rkV, 
	const Matrix3<Real>& rkM, const Vector3<Real>& rkCenter )
{
	Vector3<Real> kRes = rkV - rkCenter;
	kRes = kRes * rkM;
	kRes += rkCenter;
	return kRes;
}
...
template <class Real>
Vector3<Real> Rotate( const Vector3<Real>& rkV, 
	const Vector3<Real>& rkCenter, const Vector3<Real>& rkDir, Real tAngle )
{
	Vector3<Real> kRes = rkV - rkCenter;
	Vector3<Real> kAxis = rkDir - rkCenter;
	Matrix3<Real> kRotate;
	kRotate.ToAxisAngle( kAxis, tAngle );
	kRes = kRes * rkM;
	kRes += rkCenter;
	return kRes;
}
