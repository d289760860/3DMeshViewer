...
const QMetaObject ChildWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ChildWidget.data,
      qt_meta_data_ChildWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ChildWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChildWidget.stringdata0))
        return static_cast<void*>(const_cast< ChildWidget*>(this));
